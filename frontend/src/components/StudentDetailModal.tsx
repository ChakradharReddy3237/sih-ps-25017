...
const AlumniLayout: React.FC<AlumniLayoutProps> = ({ children }) => {
  ...
  const navigation = [
    ...
    { name: 'My Contributions', href: '/alumni/contributions', icon: Heart },
    { name: 'Events', href: '/alumni/events', icon: Calendar },
  ];

  const isActive = (href: string) => location.pathname === href || 
    (href === '/alumni/dashboard' && location.pathname === '/alumni');
        ...
        <div className="p-6 border-b border-blue-800">
          <div className="flex items-center space-x-3">
            ...
            <div>
              ...
              <p className="text-blue-200 text-sm">Alumni Portal</p>
            </div>
          </div>
        </div>
        ...
        <div className="p-4 border-t border-blue-800">
          <div className="flex items-center space-x-3 mb-4">
            ...
            <div>
              ...
              <p className="text-blue-200 text-sm">Alumni</p>
            </div>
          </div>
          <button
            onClick={logout}
